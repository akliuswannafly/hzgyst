...
<div class="block clearfix" style="background: none repeat scroll 0 0 #FFFFFF;">
    ...
    <div class="box">
     <div class="box_1" style="border:0;">
      <div style=" background-color:#fff; padding:20px 15px;">
         ...
         <font class="f5 f6" style="color:#1D5E3B;"><?php echo htmlspecialchars($this->_var['article']['title']); ?></font><br /><font class="f3"><?php echo htmlspecialchars($this->_var['article']['author']); ?> / <?php echo $this->_var['article']['add_time']; ?></font>
         </div>
         ...
         <div><a href="<?php echo $this->_var['article']['file_url']; ?>" target="_blank"><?php echo $this->_var['lang']['relative_file']; ?></a></div>
          <?php endif; ?>
         <div style="padding:8px; margin-top:15px; text-align:left; border-top:1px solid #ccc;display:none">
